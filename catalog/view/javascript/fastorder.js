jQuery(document).ready(function(){
 ...
 var BlockHTML = '<div id="close_w"><a href="javascript:void(0);"><img src="'+ THEMEURL +'close.gif" border="0" id="close_remind" /></a></div><div class="fast_order_desc">Заказать звонок</div><div class="msg_error" id="auth_err"></div><div class="msg_ok" id="auth_ok"> </div><form onsubmit="return false;"><input id="pID" name="productID" value="" type="hidden" /><div class="elem"><div class="call">Имя</div><div class="block overflow"><span class="field"><input class="required" type="text" name="name" id="name" value="" /></span></div></div><div class="elem"><div class="call">Телефон</div><div class="block overflow"><span class="field"><input class="required" type="text" id="phone" name="phone" value="" /></span></div></div><div class="elem"><div class="call">E-mail</div><div class="block overflow"><span class="field"><input type="text" name="email" id="email" value="" /></span></div></div><div class="elem"><div class="call"></div><div class="block overflow"><span class="field"><input type="button" id="go" style=" background-image:none; background-color:rgb(237,180,65);" class="button" value="Отправить" /><input id="data_url" type="hidden" name="url" value="" /><input id="product" type="hidden" name="product" value="" /></span></div></div></form>';
  ...
  jQuery('body').append('<div id="fast_order"></div>');
	...
	jQuery('.fastorder').live("click",function(){
		...
		jQuery('#fast_order .fast_order_desc').html('Заказать звонок <span>'+name+'</span>');
